...
function reflection_update!(
    ...
    try
        ...
        @info "Failed to evaluate Green's function matrix for proposed state in reflection update." exception=(e, catch_backtrace())
...
function reflection_update!(
    ...
    try
        ...
        @info "Failed to evaluate Green's function matrix for proposed state in reflection update, update rejected." exception=(e, catch_backtrace())
