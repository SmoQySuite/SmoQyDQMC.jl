...
function compress_jld2_bins(
    ...
    # compress the jld2 bin files for process ID pID into a single JLD2 file
    if pID ≥ 0
    ...
    # have root process (pID = 0) compress all binned data generated by all processes
    # into a single JLD2 file
