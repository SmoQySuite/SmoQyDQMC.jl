...
function run_simulation()
    ...
    # measure time-displaced spin-down green's function
    initialize_correlation_measurements!(
        measurement_container = measurement_container,
        model_geometry = model_geometry,
    ...
    # initialize fermion path integrals to hubbard ising hubbard-stratonovich transformation parameters
    ...
    for n in 1:N_burnin
        ...
        # perform reflection update to ising hubbard-stratonovich fields on a randomly chosen orbital
        ...
        # record accept/reject outcome for reflection update
