...
function run_simulation()
    ...
    for n in 1:N_burnin
        ...
        (acceptance_rate, logdetGup, sgndetGup, logdetGdn, sgndetGdn, δG, δθ) = hmc_update!(
    ...
    println()
    println("Measurements Beginning")
    ...
    process_measurements(simulation_info.datafolder, 10)
